...
export default async function Page({}: Props) {
  ...
  return (
    <div className="w-full flex flex-col items-center flex-1">
      <div className="w-full flex flex-col justify-center max-w-7xl px-1 md:px-5 pt-4">
        <h1 className="font-bold text-4xl text-center text-balance px-7 md:px-3">
          Blog
        </h1>
        <div className="w-full flex flex-wrap mt-6">
          {posts.length > 0 ? (
            ...
            <div className="w-full flex flex-col items-center text-muted-foreground">
              ...
              <p className="w-full text-center px-4 text-balance mt-2">
                No blog posts yet.
              </p>
            </div>
          )}
