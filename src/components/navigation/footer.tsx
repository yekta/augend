  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl px-2 md:px-6">
        <div className="w-full overflow-hidden flex items-center justify-between py-3 md:py-2 gap-2 px-2 ring-1 ring-border rounded-t-xl">
          <div className="size-8.5 shrink-0 hidden md:flex" />
          <div className="pl-1.5 md:pl-0 pr-1 md:pr-0 shrink min-0 overflow-hidden font-medium flex flex-col md:flex-row text-sm text-muted-foreground">
