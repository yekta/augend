export default function DashboardWrapper({
  ...
  return (
    ...
    >
      <div className="w-full flex group-data-[center-items]/wrapper:items-center group-data-[center-items]/wrapper:justify-center max-w-7xl px-1 pt-1 pb-16 md:pb-20 md:px-5 md:pt-5 flex-wrap">
        {children}
      </div>
    </div>
  );
