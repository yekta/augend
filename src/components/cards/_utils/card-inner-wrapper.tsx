  ...
  return (
    <div
      className={cn(
        ...
        "group-focus-visible/card:ring-1 group-focus-visible/card:ring-primary/50 group-focus-visible/card:ring-offset-2 group-focus-visible/card:ring-offset-background",
