  ...
  return (
    ...
    >
      <CardInnerWrapper className="flex flex-col flex-1">
        ...
        <Button
          disabled={!data}
          className="absolute top-1.5 bg-transparent rounded-lg right-1.5 p-0 group-data-[loading-error]/card:text-destructive"
          variant="outline"
  ...
  return (
    <div className={cn("h-36", className)}>
      <Link
        target="_blank"
        href={href || "placeholder"}
        className="relative h-full group/link"
      >
        <div
        ...
        >
          <div
            className="h-full relative z-0 not-touch:group-hover/link:opacity-25 group-active/link:opacity-25 transition
            group-focus-visible/link:opacity-25"
          >
            <img
              width="290"
              height="500"
          ...
          <ExternalLinkIcon
            ...
            group-focus-visible/link:opacity-100 group-focus-visible/link:scale-100"
          />
        </div>
      </Link>
    </div>
