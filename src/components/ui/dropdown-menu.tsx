    ...
    return (
      <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
          ...
          className={cn(
            "z-50 max-w-[var(--radix-popper-available-width)] max-h-[min(20rem,var(--radix-popper-available-height))] flex flex-col overflow-hidden rounded-md border bg-popover p-0 text-popover-foreground shadow-lg shadow-shadow/[var(--opacity-shadow)]",
